...
class OrderController extends Controller
{
    ...
    public function updateOrderStatus(Request $request){
        if ($request->isMethod('post')) {
            ...
            // OrdersProduct::where('order_id', $data['order_id'])->update([
            //     'item_status' => $data['order_status'],
            // ]);
            ...
            if (!empty($data['courier_name']) && !empty($data['tracking_number'])) {
                ...
                Mail::send('emails.order_status', $messageData, function($message)use($email){
                    $message->to($email)->subject('Order Status Updated - ShopMama E-commerce');
                });
    ...
    public function updateOrderItemStatus(Request $request){
        if ($request->isMethod('post')) {
            ...
            //  Send order item status update email and sms
            ...
            $orderDetails = Order::with(['orders_products' => function($query)use($orderItemId){
            ...
            if (!empty($data['item_courier_name']) && !empty($data['item_tracking_number'])) {                
                ...
                Mail::send('emails.order_item_status', $messageData, function($message)use($email){
                    $message->to($email)->subject('Order Item Status Updated - ShopMama E-commerce');
                });
            ...
            <header class="clearfix">
                <div class="container">                    
                    <div class="company-address">
                        <h2 class="title">Shopmama Ecom</h2>
                        <p>
                            House #24, Road #16, Sector #14,<br>
                            Uttara, Dhaka, Bangladesh
                        </p>
                    </div>
                    <div class="company-contact">
                        <div class="phone left" style="display:float;">
                            ...
                            <a href="tel:880-1854229083">(880) 1854229083</a>
                        ...
                        <div class="email right">
                            ...
                            <a href="mailto:mdtohin8585@gamail.com">mdtohin8585@gamail.com</a>
                            <span class="helper"></span>
                        </div>
                    </div>
                </div>
            ...
            <section>
                <div class="container">
                    <div class="details clearfix">
                        ...
                        <p>'.$orderDetails['city'].', '.$orderDetails['state'].', '.$orderDetails['country'].' - ('.$orderDetails['pincode'].').'.'</p>
                        ...
                        <div class="data right">
                            ...
                            <div class="date">
                                Order Date: '.date("M d, Y H:i:s", strtotime($orderDetails['created_at'])).' <br>
                                Order Amount: Tk. '.round($orderDetails['grand_total']). '<br>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0">
                        <thead>
                            <tr>
                                ...
                                <th class="unit" style="white-space: nowrap;">Unit price</th>
                        ...
                        <tbody>';
                            ...
                            foreach ($orderDetails['orders_products'] as $product){   
                                $invoiceHTML .= '<tr>
                                    ...
                                    <td class="unit" style="white-space: nowrap;"> Tk. '.round($product['product_price']).'</td>
                                    <td class="total" style="white-space: nowrap;"> Tk. '.round($product['product_price']*$product['product_qty']).'</td>
                                </tr>';
                        ...
                        <table class="grand-total">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="total"> Tk. '.round($subtotal).'</td>
                                </tr>
                                <tr>
                                    <td class="desc"></td>
                                    <td class="desc"></td>
                                    ...
                                    <td class="total"> Tk. '.round($orderDetails['shipping_charges']).'</td>
                                </tr>
                                <tr>
                                    <td class="desc"></td>
                                    <td class="desc"></td>
                                    <td class="qty"></td>
                                    <td class="unit" colspan="2">COUPON DISCOUNT:</td>';
                                    if($orderDetails['coupon_amount'] > 0){
                                        $invoiceHTML .='<td class="total"> Tk. '.round($orderDetails['coupon_amount']).'</td>';
                                    }else{
                                        $invoiceHTML .='<td class="total"> Tk. 0'.'</td>';
                                    }                                    
                                    $invoiceHTML .='</tr>
                                <tr>
                                    <td class="desc"></td>
                                    ...
                                    <td class="total"> Tk. '.round($orderDetails['grand_total']).'</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
