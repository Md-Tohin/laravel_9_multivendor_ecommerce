...
<body>
    <table style="width: 700px;">
        ...
        <tr><td>
            <table style="width: 95%;" cellpadding="5" cellspacing="5" bgcolor="#f7f4f4">
                ...
                <tr>
                    ...
                    <td style="text-align: right;">Tk. {{ $orderDetails['shipping_charges'] }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="text-align: right;">Tk. {{ $orderDetails['grand_total'] }}</td>
                </tr>
            </table>
        </td></tr>
        <tr><td>&nbsp;</td></tr>
        ...
        <tr><td>&nbsp;</td></tr>
        <tr><td>Download Order Invoice at <a href="{{ url('/orders/invoice/download/'.$orderDetails['id']) }}">{{ url('/orders/invoice/download/'.$orderDetails['id']) }}</a><br>(Copy & Paste to open if link does not work)</td></tr>
        <tr><td>&nbsp;</td></tr>
