                ...
                <div class="login-wrapper">
                    ...
                    <form action="{{ url('admin/login') }}" method="POST">
                        ...
                        <div class="u-s-m-b-30">
                            ...
                            <input type="text" name="email" id="vendor-email" class="text-field" placeholder="Email">
                        </div>
                        <div class="u-s-m-b-30">
                ...
                <div class="reg-wrapper">
                    ...
                    <form id="vendorForm" action="{{ url('/vendor/register') }}" method="POST">
                        ...
                        <div class="u-s-m-b-30">
                            ...
                            <input type="text" name="name" id="vendorname" class="text-field" value="{{ old('name') }}"
                        ...
                        <div class="u-s-m-b-30">
                            ...
                            <input type="text" name="mobile" id="vendormobile" class="text-field"
                                value="{{ old('mobile') }}" placeholder="Vendor Mobile">
                        </div>
                        <div class="u-s-m-b-30">
                            <label for="vendoremail">Email
                                <span class="astk">*</span>
                            </label>
                            <input type="text" name="email" id="vendoremail" class="text-field"
                                value="{{ old('email') }}" placeholder="Vendor Email">
                        </div>
                        <div class="u-s-m-b-30">
