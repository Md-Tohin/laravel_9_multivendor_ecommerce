...
@section('content')
            ...
            @foreach ($sliderBanners as $sliderBanner)
                <div class="bg-image">
                    <div class="slide-content">
                        <h1>
                            @if (!empty($sliderBanner['image']) && file_exists('front/images/banner_images/' . $sliderBanner['image']))
                                <img src="{{ asset('front/images/banner_images/' . $sliderBanner['image']) }}"
                                    title="{{ $sliderBanner['title'] }}" alt="{{ $sliderBanner['alt'] }}">
                            @else
                                <img src="{{ asset('front/images/banner_images/no_image.jpg') }}">
                            @endif
        ...
        <div class="banner-layer">
            <div class="container">
                <div class="image-banner">
                    <a target="_blank" rel="nofollow" href="{{ $fixBanners[0]['link'] }}"
                        class="mx-auto banner-hover effect-dark-opacity" title="{{ $fixBanners[0]['title'] }}">
                        <img class="img-fluid" src="{{ url('front/images/banner_images/' . $fixBanners[0]['image']) }}"
                ...
                <div class="outer-area-tab">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane show fade" id="men-best-selling-products">
                            <div class="slider-fouc">
                                <div class="products-slider owl-carousel" data-item="4">
                                    @foreach ($bestSelllers as $product)
                                        @php
                                            $product_image_path = 'front/images/product_images/small/' . $product['product_image'];
                                        @endphp
                                        <div class="item">
    ...
    @if (isset($fixBanners[1]['image']))
        <div class="banner-layer">
            <div class="container">
                <div class="image-banner">
                    <a target="_blank" rel="nofollow" href="{{ $fixBanners[1]['link'] }}"
                        class="mx-auto banner-hover effect-dark-opacity" title="{{ $fixBanners[1]['title'] }}">
                        <img class="img-fluid" src="{{ url('front/images/banner_images/' . $fixBanners[1]['image']) }}"
