...
<div class="u-s-m-b-24 newAddress">
    <input type="checkbox" class="check-box" id="ship-to-different-address" data-toggle="collapse"
        ...
        @else
            <label class="label-text" for="ship-to-different-address">Click to add Delivery address?</label>
        @endif
            ...
            <div class="group-1 u-s-p-r-16">
                ...
                <div class="select-box-wrapper">                
                    <select name="delivery_country" id="country" class="select-box">
                        ...
                        <option value="{{ $country->country_name }}" @if (isset($address['country']) && $address['country'] == $country['country_name']) selected @endif>{{ $country->country_name }}</option>
                        @endforeach
                    </select>
                </div>
